...
export const canisterId = process.env.TOKEN2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token2.did.js")._SERVICE>}
 */
export const token2 = createActor(canisterId);
